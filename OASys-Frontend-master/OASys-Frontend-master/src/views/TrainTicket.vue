    ...
    <div class="files">
        <el-card class="box-card" body-style="{padding: '20px' }">
            <div slot="header" class="clearfix">
                <span>操作面板</span>
                <el-button style="float: right; padding: 3px 0" type="text" @click="handleAddTrainTicket(true)">新增数据
                </el-button>
            </div>
            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    ...
                    <el-button type="danger" size="mini"
                               @click="deleteTrainTicket(scope.row)">删除
                    </el-button>
                </template>
            </el-table-column>
        </el-table>
...
<script>
    import {addTrainTicket, getTrainTicket, updateTrainTicket, deleteTrainTicket} from "../utils/api";
