  ...
  <div class="files">
    <el-card class="box-card" body-style="{padding: '20px' }">
      <el-form label-width="auto"
        ...
        <!--          <el-col :span="1.5">-->
        <!--            <el-button type="primary" @click="handleGetGoods()">recover from</el-button>-->
        <!--          </el-col>-->
        <!--          <el-col :span="1.5">-->
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button type="primary" size="mini"
                     @click="handleRecoverFrom(scope.row)">recover from
          </el-button>
...
import {
  ...
  deleteGoodsOrder,
  deleteAllGoodsOrder,
  exportGoodsOrder, getWarningGoods, recoverFromBackup, getBackups,
} from "../utils/api";
...
export default {
  ...
  methods: {
    ...
    handleRecoverFrom(row) {
      recoverFromBackup(row).then(
          response => {
    ...
    handleGetBackups(){
      getBackups(this.searchParams).then(response => {
        if (response && response.status === "success") {
